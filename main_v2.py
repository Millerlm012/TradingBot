...
'''main_v2 will be utilizing StreamConn and will hopefully be the final program for live testing'''

'''
NOTES:
- reorganize code / clean
- determine how to extract certain values from the chunk of data being pulled
'''
